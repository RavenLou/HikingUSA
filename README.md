...
Developed by Yuqing Lou

•	This is a full-stack web application with CRUD operations for users to add, view, update, and delete posts of hiking trails
•	Achieved features including user authentication through Passport, Google, and Facebook, geocoded maps with Mapbox, trail rating, comment posting, and image uploading
